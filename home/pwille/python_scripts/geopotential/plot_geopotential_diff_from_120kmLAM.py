...
############################################################################
##  Heights
    f_glob_h = '/projects/cascade/pwille/temp/408_pressure_levels_interp_pressure_djzny_%s' % (plot_type)
    f_glob_d = '/projects/cascade/pwille/temp/%s_pressure_levels_interp_djzny_%s' % (plot_diag, plot_type)
...
# Wind
    fw_global = '/projects/cascade/pwille/moose_retrievals/djzn/djzny/30201_mean.pp'
    fo_global = '/projects/cascade/pwille/moose_retrievals/djzn/djzny/33.pp'
...
Basemap(llcrnrlon=lon_low,llcrnrlat=lat_low,urcrnrlon=lon_high,urcrnrlat=lat_high, rsphere = 6371229)
        ...
        if plot_diag=='temp':
             ...
             cbar.set_label('K')  
             plt.suptitle('Difference from 120km LAM (Model - 120km LAM ) of Height, Potential Temperature and Wind Vectors  at %s hPa'% (p), fontsize=10)  
             ...
             plt.suptitle('Difference from 120km LAM (Model - Global Model ) of Height, Specific Humidity and Wind Vectors  at %s hPa'% (p), fontsize=10) 
        ...
        #plt.savefig('/home/pwille/figures/%s/%s/geop_height_difference_120LAM_%shPa_%s_%s.tiff' % (experiment_id, plot_diag, p, experiment_id, plot_diag), format='tiff', transparent=True)
