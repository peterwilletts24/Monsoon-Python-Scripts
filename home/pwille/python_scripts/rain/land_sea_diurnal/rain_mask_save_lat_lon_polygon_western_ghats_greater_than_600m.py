...
polygon = Polygon(((73.75, 8.75), (70., 22.), (73.75, 22.), (77.75, 8.75)))
...
# For Sea and Land, mask area and calculate mean of each hour for sea/land and SAVE as numpy array
    ...
    #trnp=[total_diurnal_mean_cube.data.data, diurnal_mean_cube.coord('hour').points+0.5]
    #print total_diurnal_mean_cube
    #np.save('%s%s/%s/%s_total_rainfall_diurnal_np_domain_constrain_western_ghats' % (pp_file_path, expmin1, experiment_id, diag), trnp) 
    ...
    for s in ([1]):
     ...
     #    print total_rainfall  
         #np.save('%s%s/%s/%s_sea_rainfall_diurnal_np_domain_constrain_western_ghats' % (pp_file_path, expmin1, experiment_id, diag), trnp)
     ...
     if s == 1:
          # Areas of land
         np.save('%s%s/%s/%s_land_rainfall_diurnal_np_domain_constrain_western_ghats_heights_%s_%sm' % (pp_file_path, expmin1, experiment_id, diag, height_min, height_max), trnp) 
