...
#experiment_ids = ['djzns', 'djznq', 'djzny', 'djznw', 'dkjxq', 'dklyu', 'dkmbq', 'dklwu', 'dklzq']
...
# Some models have radiation diagnostics that are 10s offset from others so checking int values of time 
 ...
 for t, time_cube in enumerate (cube.slices(['time', 'grid_latitude', 'grid_longitude'])):
    #print time_cube
     ...
     iris.save((u_mean),'/projects/cascade/pwille/moose_retrievals/%s/%s/%s_mean.pp' % (expmin1, experiment_id, diag))
