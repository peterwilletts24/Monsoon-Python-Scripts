...
# iris.analysis.maths.multiply(rain,60*(60*time_interval),in_place=True)
 ...
 rain_mean = cube_r.aggregated_by('day_of_year', iris.analysis.MEAN)
 iris.save((rain_mean),'/projects/cascade/pwille/moose_retrievals/%s/%s/rain_mean_by_day_regrid.pp' % (expmin1, experiment_id))
