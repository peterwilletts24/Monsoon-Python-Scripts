...
def main():
 #experiment_ids = ['djzns', 'dkbhu', 'dkjxq', 'dklyu', 'dkmbq', 'dklwu', 'dklzq' ]
 ...
 for experiment_id in experiment_ids:
  ...
  try:
    ...
    fname = '/projects/cascade/pwille/moose_retrievals/%s/%s/408_2.pp' % (expmin1, experiment_id)
    fname_heights = '/projects/cascade/pwille/moose_retrievals/%s/%s/15101.pp'% (expmin1, experiment_id)

    save_name_i='/408_pressure_levels_interp_pressure_%s_2' % experiment_id
