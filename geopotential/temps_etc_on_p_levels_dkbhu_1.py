...
def main():
 ...
 for experiment_id in experiment_ids:
  ...
  try:
      ...
      fname_temp = '/projects/cascade/pwille/moose_retrievals/%s/%s/4_1.pp' % (expmin1, experiment_id)
      fname_sp_hum= '/projects/cascade/pwille/moose_retrievals/%s/%s/10_1.pp' % (expmin1, experiment_id)
